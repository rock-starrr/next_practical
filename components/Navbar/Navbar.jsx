                                            ...
                                            <div className='max-md:mr-2'>
                                                {!isAuth ? (
                                                    <div className='h-full flex items-center'>
                                                        <button
                                                            className="text-white bg-blue-700 hover:bg-blue-800 focus:bg-blue-800 outline-none font-medium rounded-lg text-sm px-4 py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:bg-blue-700"
                                                            onClick={() => {
                                                                router.push(`/login`)
                                                            }}
                                                        >
