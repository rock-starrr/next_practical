...
export const EditTodoModal = ({ id }) => {
    ...
    return (
        <>
            <button
                className="bg-blue-700 mt-1 mr-1 p-1 pl-3 pr-3 text-white rounded-full outline-none text-sm ext-center dark:bg-blue-600 disabled:bg-blue-500 dark:disabled:bg-blue-400"
                type="button"
                onClick={() => {
                    setOpen(!open)
                }}
                        ...
                        <div className="p-3 md:p-5 space-y-4">
                            <form className="space-y-6" onSubmit={handleSubmit(addTodoData)}>
                                <div className='p-2 pt-0'>
                                    ...
                                    <div className='mt-2'>
                                        <select
                                            className={`block py-2.5 px-0 w-full text-sm text-black bg-transparent border-0 border-b-2 border-gray-200  dark:text-gray-400 dark:border-gray-200 focus:outline-none focus:ring-0 focus:border-gray-200 peer`}
