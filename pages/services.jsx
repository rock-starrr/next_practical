    ...
    return (
        <>
            ...
            <div className='dark:bg-black dark:text-gray-200 min-h-screen'>
                <div className='overflow-y-hidden'>
                    <div className="xl:mx-auto xl:container  xl:px-20 md:px-6 px-4 py-12">
                        <div className="lg:flex items-center justify-center lg:space-x-12 2xl:space-x-6">
                            <div>
                                <p className="lg:text-4xl text-3xl font-extrabold leading-9 text-gray-800 dark:text-gray-100">Why choose us</p>
                                <p className="text-lg leading-7 text-gray-600 mt-4 xl:w-7/12 w-full dark:text-gray-200">Whether article spirits new her covered hastily sitting her. Money witty books nor son add</p>
                                ...
                                <div className="mt-6 md:mt-10 grid sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 gap-6 lg:mt-6 2xl:mt-12">
                                    <div className="flex items-center">
                                        ...
                                        <div className="flex items-start flex-col ml-6 pt-8">
                                            <h2 className="text-lg font-semibold leading-4 text-gray-800 dark:text-gray-100">Time Prompt</h2>
                                            <p className="lg:w-40 2xl:w-52 text-base leading-6 mt-2 text-gray-600 dark:text-gray-200">Whether article spirits new her covered.</p>
                                        </div>
                                    </div>
                                    <div className="flex items-center">
                                        <div className="w-16 h-16 relative">
                                        ...
                                        <div className="flex items-start flex-col ml-6 pt-8">
                                            <h2 className="text-lg font-semibold leading-4 text-gray-800 dark:text-gray-100">User Friendly</h2>
                                            <p className="lg:w-40 2xl:w-52 text-base leading-6 mt-2 text-gray-600 dark:text-gray-200">Whether article spirits new her covered.</p>
                                        </div>
                                    </div>
                                    <div className="flex items-center">
                                        ...
                                        <div className="flex items-start flex-col ml-6 pt-8">
                                            <h2 className="text-lg font-semibold leading-4 text-gray-800 dark:text-gray-100">Creative Ideas</h2>
                                            <p className="lg:w-40 2xl:w-52 text-base leading-6 mt-2 text-gray-600 dark:text-gray-200">Whether article spirits new her covered.</p>
                                        </div>
                                    </div>
                                    <div className="flex items-center">
                                        ...
                                        <div className="flex items-start flex-col ml-6 pt-8">
                                            <h2 className="text-lg font-semibold leading-4 text-gray-800 dark:text-gray-100">Achievments</h2>
                                            <p className="lg:w-40 2xl:w-52 text-base leading-6 mt-2 text-gray-600 dark:text-gray-200">Whether article spirits new her covered.</p>
                                        </div>
                                    </div>
                                </div>
                ...
                <div className="overflow-y-hidden bg-gray-100 dark:bg-black">
                    <div className="mx-auto container f-f-p px-4 xl:px-0 py-24">
                        <h1 className="focus:outline-none text-center text-3xl lg:text-4xl font-extrabold lg:leading-9 tracking-wider text-gray-900 dark:text-gray-100">How it works?</h1>
                            ...
                            <div className="hidden md:flex justify-center w-full">
                                <div className="flex flex-col items-center md:items-end md:pr-12 md:border-r-4 border-gray-300 relative md:w-1/2">
                                    ...
                                    <div className="flex mt-12 flex-col items-center lg:items-end md:w-8/12">
                                        ...
                                        <h2 className="focus:outline-none text-gray-500 mt-3 pl-3 text-center md:text-right text-base leading-6 tracking-wide dark:text-gray-200">Create a wallet by linking a payment method that you’re comfortable with. Paypal, Visa and more </h2>
                                    </div>
                                ...
                                <div className="flex flex-col items-center md:items-start md:pl-12 lg:border-gray-400 mt-20 md:mt-0 md:w-1/2">
                                    ...
                                    <div className="flex mt-6 flex-col items-center md:items-start md:w-8/12">
                                        ...
                                        <h2 className="focus:outline-none text-gray-500 mt-3 text-base leading-6 tracking-wide dark:text-gray-200">Sign up on our website and opt for a program that suits you the best . </h2>
                                    </div>
                                    ...
                                    <div className="flex mt-6 flex-col items-center md:items-start md:w-8/12">
                                        ...
                                        <h2 className="focus:outline-none text-gray-500 mt-3 text-base leading-6 tracking-wide dark:text-gray-200">Start transactions right away. No more complicated process for anything else.</h2>
                                    </div>
                                </div>
                            </div>
