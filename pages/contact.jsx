...
const Contact = () => {
  ...
  return (
    <>
      ...
      <Navbar />
      <div className="container mx-auto pt-10 pb-10 dark:bg-black dark:text-gray-200 min-h-screen">
        <div className="lg:flex">
          ...
          <div className="xl:w-3/5 lg:w-3/5 bg-gray-200 h-full pt-5 pb-5 xl:pr-5 xl:pl-0 rounded-tr rounded-br dark:bg-gray-800">
            <form
              className="bg-white py-4 px-8 rounded-tr rounded-br dark:bg-black"
              onSubmit={(e) => {
                e.preventDefault()
                setInputData({ fullName: '', email: '', phone: '', massage: '' })
                toast('Data Submited')
              }}
            >
              <h1 className="text-4xl text-gray-800 font-extrabold mb-6 dark:text-gray-100">Enter Details</h1>
                ...
                <div className="w-2/4 max-w-xs mb-6 xl:mb-0">
                  <div className="flex flex-col">
                    ...
                    <input
                      required
                      type="text"
                      className="focus:outline-none focus:border focus:border-indigo-700 font-normal w-64 h-10 flex items-center pl-3 text-sm border-gray-300 rounded border dark:bg-gray-800 dark:text-gray-200 dark:border-none"
              ...
              <div className="w-full mt-6">
                <div className="flex flex-col">
                  ...
                  <textarea
                    className="border-gray-300 border mb-4 rounded py-2 text-sm outline-none resize-none px-3 focus:border focus:border-indigo-700 dark:bg-gray-800 dark:text-gray-200 dark:border-none" rows={8}
                    value={inputData.massage}
                    onChange={(e) => {
                      setInputData({ ...inputData, massage: e.target.value })
                    }}
                  />
                </div>
                <button
